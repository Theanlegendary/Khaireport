...
def build_penalty_report(src_xlsx, out_xlsx, target_label="ALL", report_date=None):
    ...
    # STRICT SORT: From lowest % RIGHT Handover to highest (or highest penalty fine first)
    def calc_sort_key(stats):
        ...
        # Sort strictly by % RIGHT Handover, then % RIGHT Delivery, then penalty fine
    ...
    fill_pen_red = PatternFill("solid", fgColor="FFEAEA") # Light Red / Light Pink Highlight
    ...
    for stats in sorted_branches:
        ...
        for ci, val in enumerate(s_vals, 10):
            ...
            elif ci == 18: # Total Penalty ($) -> Light Red Highlight + Bold Red text
